...
export default function TermsPage() {
  ...
  useEffect(() => {
    fetchSections().then(data => {
      const section = data.find(s => s.section_name === 'terms')
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
          ...
          <div className="lg:col-span-3">
            <div className="sticky top-32">
              <h3 className="font-heading text-2xl text-charcoal mb-4">Legal Agreement</h3>
              ...
              <h4 className="text-xs font-sans font-semibold tracking-[2px] uppercase text-charcoal mb-4">Need Clarification?</h4>

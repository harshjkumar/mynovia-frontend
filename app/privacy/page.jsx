...
export default function PrivacyPage() {
  ...
  useEffect(() => {
    fetchSections().then(data => {
      const section = data.find(s => s.section_name === 'privacy')
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
          ...
          <div className="lg:col-span-3">
            <div className="sticky top-32">
              <h3 className="font-heading text-2xl text-charcoal mb-4">Data Protection</h3>
              <p className="text-sm text-body-gray font-body leading-relaxed mb-8">
                We are committed to protecting your personal data and respecting your privacy. Please review this document to understand how we handle your information.
              </p>
              <div className="h-[1px] bg-gray-200 mb-8 w-full"></div>
              <h4 className="text-xs font-sans font-semibold tracking-[2px] uppercase text-charcoal mb-4">Contact Privacy Team</h4>
